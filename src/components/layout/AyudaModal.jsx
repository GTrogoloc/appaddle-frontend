...
function AyudaModal({ mostrarAyuda, setMostrarAyuda }) {
  ...
  <p className="leading-relaxed">
    Bienvenido al centro de ayuda. Aquí encontrarás información para utilizar el sistema.
  </p>
</div>
        {/* CONTENIDO */}
        <div className="flex-1 overflow-y-auto space-y-5 text-sm border-t pt-4">
          ...
          <div className="bg-gray-50 p-4 rounded-md border">
            <h4 className="font-semibold mb-2 flex items-center gap-2">🎾 Sobre el sistema</h4>
  ...
  <p className="text-gray-700 mt-1">
    ...
    estadísticas de ocupación para mejorar la planificación
    y el rendimiento de tu club en un solo lugar.
  </p>

            <p className="text-gray-700 mt-1">
    Desarrollado con el objetivo de simplificar la gestión diaria
    del club y brindar herramientas útiles para tomar mejores decisiones.
  </p>
          ...
          {/* GUIA RAPIDA */}
          <div className="bg-gray-50 p-4 rounded-md border">
          <h4 className="font-semibold mb-2 flex items-center gap-2">📘 Guía rápida</h4>
            ...
            <ul className="space-y-1">
              ...
              <li>🗑 Abrí una reserva existente para cancelarla si es necesario.</li>
          ...
          {/* CONSEJOS */}
          <div className="bg-gray-50 p-4 rounded-md border">
          <h4 className="font-semibold mb-2 flex items-center gap-2">💡 Consejos de uso</h4>
          ...
          {/* PROBLEMAS COMUNES */}
          <div className="bg-gray-50 p-4 rounded-md border">
          <h4 className="font-semibold mb-2 flex items-center gap-2">⚠️ Problemas comunes</h4>

            <ul className="space-y-1">
              <li>❌ No puedo reservar un horario → probablemente ya esté ocupado o fuera de horario.</li>
          ...
          <div className="bg-gray-50 p-4 rounded-md border">
          <h4 className="font-semibold mb-2 flex items-center gap-2">📱 Contacto de Soporte</h4>
